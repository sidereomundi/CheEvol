...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      IF(H.GE.mlow1.and.H.le.mup1) THEN !!! TUTTE LE STELLE MASSICCE POSSONO
         ...
         if (Rando.le.0.1) then 
            ...
            value1=value1*0.1 ! because on average!!! OMOG
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        if ((h.gt.15).and.(h.lt.40).and.(Rando.gt.0.)) then
...
!!! il 0.01 che scoppia 1Gyr anno produce questo Litio!
!         if (zeta.lt.0.02) then
         Q(31)= 2.E-6*4.*1.
         !else
         !   Q(31)= 0.         
!     endif
...
c
     ...
     $           ba138,ba139,ba140
            ...
            if (j.eq.5) write(*,*) 'Ba',massaba(j),ba(j,i)
         enddo
      enddo
      ...
      do j=1,5
         do i=1,9
            ...
            if (j.eq.1) write(*,*) 'Sr',massaba(j),sr(j,i)
      ...
      do j=1,5
         do i=1,9
            ...
            Yt(j,i)=Y89
            if (j.eq.1) write(*,*) 'Y',massaba(j),Yt(j,i)
     ...
     $           Eu56,Eu57
            ...
            if (j.eq.1) write(*,*) 'Eu',massaba(j),Eu(j,i)
     ...
     $           Zr95,Zr96,Zr97
            ...
            if (j.eq.1) write(*,*) 'Zr',massaba(j),Zr(j,i)
      ...
      do j=1,5
         do i=1,9
            ...
            if (j.eq.1) write(*,*) 'La',massaba(j),La(j,i)
      ...
      do j=1,5
         do i=1,9
            ...
            if (j.eq.1) write(*,*) 'Rubidium',massaba(j),Rb(j,i)
